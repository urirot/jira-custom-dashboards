          ...
          >
            ...
            >
              <div style={{ textAlign: "center" }}>
                ...
                >
                  {metrics.estimationAccuracy.onTimePercentage}%
                </div>
              ...
              <div style={{ textAlign: "center" }}>
                ...
                >
                  {metrics.estimationAccuracy.underTimePercentage}%
                </div>
                <div style={{ fontSize: "14px", color: "#666" }}>
                  Under Estimate
                </div>
              ...
              <div style={{ textAlign: "center" }}>
                ...
                >
                  {metrics.estimationAccuracy.overTimePercentage}%
                </div>
                <div style={{ fontSize: "14px", color: "#666" }}>
                  Over Estimate
                </div>
              ...
              <div style={{ textAlign: "center" }}>
                <div
                  style={{
                    ...
                    fontWeight: "bold",
                    color:
                      metrics.estimationAccuracy.averageAccuracy <= 100
                        ? "#7ED321"
                        : "#D0021B", // Green if <= 100%, Red if > 100%
                  }}
                >
                  {metrics.estimationAccuracy.averageAccuracy}%
                </div>
                <div style={{ fontSize: "14px", color: "#666" }}>
                  Avg Accuracy
                </div>
            ...
            >
              ...
              >
                ...
                <div
                  style={{
                    ...
                    fontWeight: "bold",
                    color:
                      metrics.timeMetrics.efficiency <= 100
                        ? "#7ED321" // Green when actual effort <= estimated
                        : "#D0021B", // Red when actual effort > estimated
                  }}
                >
                  {metrics.timeMetrics.efficiency}%
                </div>
              ...
              >
                ...
                >
                  {metrics.timeMetrics.averageCycleTime} SP
                </div>
                <div style={{ fontSize: "12px", color: "#999" }}>
                  Per ticket average
                </div>
              ...
              >
                ...
                >
                  {metrics.timeMetrics.totalEstimatedHours} →{" "}
                  {metrics.timeMetrics.totalActualHours} SP
                </div>
                <div style={{ fontSize: "12px", color: "#999" }}>
                  Estimated → Actual
                </div>
            ...
            {/* Top Performers */}
            {metrics.estimationAccuracy.ticketAccuracy.length > 0 && (
              <div>
                <h4
                  style={{
                    margin: "0 0 12px 0",
                ...
                >
                  Estimation Performance by Ticket (Actual/Estimated %)
                </h4>
                <div
                  style={{
                    maxHeight: "200px",
                ...
                >
                  {metrics.estimationAccuracy.ticketAccuracy
                    .slice(0, 10)
                    .map((ticket) => (
                      <div
                        key={ticket.key}
                        ...
                        <div style={{ textAlign: "right", marginLeft: "12px" }}>
                          <div
                            style={{
                              ...
                              color:
                                ticket.accuracy <= 100
                                  ? "#7ED321" // Green for on-time or under-estimate
                                  : ticket.accuracy > 120
                                  ? "#D0021B" // Red for over-estimate (>20% over)
                                  : "#F5A623", // Orange for slightly over-estimate
                            }}
                          >
                            {ticket.accuracy}%
                          </div>
                          <div style={{ color: "#999", fontSize: "11px" }}>
                            {ticket.estimated}→{ticket.actual} SP
                          </div>
                        </div>
                      </div>
                    ))}
